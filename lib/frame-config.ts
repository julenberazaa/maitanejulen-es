...
export const OVERLAY_FRAMES: OverlayFrame[] = [
  // Primeras escapadas
  { id: 'carousel-frame-anchor', src: '/frames/frame-02.png', x: 146, y: 1562, width: DEFAULT_WIDTH, height: DEFAULT_HEIGHT, scaleX: 1.45, scaleY: 1.455, mobileOffsetY: 0, visible: true },
